        ...
        <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/5 p-6 shadow-[0_0_60px_rgba(34,211,238,0.15)] backdrop-blur-sm">
          <div className="space-y-8">
            ...
            <div className="flex flex-col gap-3">
              <label className="text-sm font-semibold tracking-[0.2em] text-cyan-400 uppercase">
                Question types
              </label>
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                {/* Genre Checkbox */}
                <label
                  className={`flex cursor-pointer items-center gap-3 rounded-xl border border-white/10 bg-black/40 px-4 py-3 transition-all hover:border-cyan-400/50`}
                >
                  <input
                    type="checkbox"
